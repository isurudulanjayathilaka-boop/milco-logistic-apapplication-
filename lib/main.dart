    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          ...
          fit: BoxFit.cover,
          colorFilter: ColorFilter.mode(Colors.white.withValues(alpha: 0.85), BlendMode.lighten),
        ),
      ),
      child: Padding(
              ...
              child: ListView(
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    // ignore: invalid_use_of_protected_member
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => FactoriesScreen())).then((_) => (context as Element).reassemble()),
                  ),
                  SizedBox(height: 20),
...
class _FactoriesScreenState extends State<FactoriesScreen> {
  ...
  void _showNewRequestDialog() {
    ...
    // Log වී සිටින යූසර්ගේ subCategory එක (CMF, DMF, PMF, SDMF) ලබාගැනීම.
    // කර්මාන්තශාලා යූසර් කෙනෙක් නම් තමන්ගේ ෆැක්ටරියෙන් පමණක් ඉල්ලීම් කළ හැක. Admin කෙනෙකුට ඕනෑම එකක් තෝරාගත හැක.
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              enabled: false, // වෙනස් කළ නොහැකි ලෙස Lock කර ඇත
